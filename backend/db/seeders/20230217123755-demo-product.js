    ...
    const data = [
      {
        ...
        photo: '/images/products/stickerPack1.jpg',
        price: 600,
        userId: 1,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        photo: '/images/products/certificate.jpg',
        price: 5000,
        userId: 1,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        photo: '/images/products/shoper1.jpg',
        price: 1500,
        userId: 1,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      },
      {
        ...
        photo: '/images/products/garland1.jpg',
        price: 1000,
        userId: 1,
        createdAt: new Date(),
        updatedAt: new Date(),
